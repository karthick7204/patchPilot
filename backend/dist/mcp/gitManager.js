...
dotenv.config();
export async function pushToNewBranch(folderPath, issueTitle, GITHUB_REPO) {
    ...
    try {
        ...
        await execAsync(`git remote set-url origin https://${process.env.GITHUB_TOKEN}@github.com/${repoPath}.git`, options);
