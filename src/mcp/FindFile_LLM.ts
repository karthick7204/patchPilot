...
async function identifyTargetFile(issueTitle: string, issueDesc: string, fileList: string[]): Promise<string> {
    const model = genai.models.generateContent({ model: "gemini-3-flash-preview" });
